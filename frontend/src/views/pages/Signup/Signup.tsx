...
const Signup: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (formData.phone === '') {
            console.log("phone");
            setPhone(false); return;
        } else setPhone(true);

        if (formData.nationality === '') {
            console.log("national");
            setNationality(false); return;
        } else setNationality(true);

        if (formData.identityNo === '') {
            console.log("identity");
            setIdentityNo(false); return;
        ...
        try {
            ...
            fDOB = moment(fDOB, "DD/MM/YYYY").format("YYYY-MM-DD") + "T07:00:00+07:00";
            //formData.dob = moment(formData.dob, "DD/MM/YYYY").format("YYYY-MM-DD") + "00:00:00.000000";
            const postTo = {
